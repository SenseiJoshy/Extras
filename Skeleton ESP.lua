...
local function draw(player, character)
    ...
    Name.Visible = false 
    Name.Color = Color3.new(3, 252, 227)
    Name.Size = 17
    Name.Center = true
    Name.Outline = true
        ...
        connection = runservice.RenderStepped:Connect(function()
            ...
            character:FindFirstChild("Humanoid").Health ~= 0 then 
                ...
                if rootpart_onscreen and character.Humanoid.RigType == Enum.HumanoidRigType.R6 and esp_settings.enabled then
                    ...
                    local Vector = camera:WorldToViewportPoint(character.Head.Position)
                    local mag = (character.HumanoidRootPart.Position - localplayer.Character.HumanoidRootPart.Position).magnitude
                    
                    Name.Position = Vector2.new(Vector.X, Vector.Y + 2)
                    Name.Text = character.Name .. " | " .. math.floor(mag)
                    ...
                    Name.Visible = esp_settings.skel
